(function ($) {
    ...
    var wedding_date = '2024-11-30 16:00:00'
...
-------------------------------------------*/
   ...
   -------------------------------------------*/
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown(wedding_date, function (event) {
    ...
    -------------------------------------------*/
    if ($("#clock2").length) {
        $('#clock2').countdown(wedding_date, function (event) {
            var $this = $(this).html(event.strftime(''
                + '<div class="box"><div><div class="time">%D</div> <span>Days</span> </div></div>'
                + '<div class="box"><div><div class="time">%H</div> <span>Hours</span> </div></div>'
                + '<div class="box"><div><div class="time">%M</div> <span>Mins</span> </div></div>'
    ...
    -------------------------------------------*/
    if ($("#clock3").length) {
        $('#clock3').countdown(wedding_date, function (event) {
            var $this = $(this).html(event.strftime(''
